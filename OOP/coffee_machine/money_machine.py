"""Коли цей клас використовується в програмі, користувачі вставлятимуть монети,
відповідаючи на запитання про кількість кожного типу монети, що імітує реальний внесок грошей в автомат.
Після цього система вирішить, чи достатньо внесено грошей для покупки, і в разі достатності видасть решту та зарахує прибуток."""
